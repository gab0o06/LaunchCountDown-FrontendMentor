...
function App() {
  ...
  const [countdown, setCountdown] = useState<DateData>(calculateCountdown());
      ...
      <main>
        <div className="main__container">
          ...
          <div className="main__cards-container">
            <Card number={countdown.daysRemaining} title="days" />
            <Card number={countdown.hoursRemaining} title="hours" />
            <Card number={countdown.minutesRemaining} title="minutes" />
            <Card number={countdown.secondsRemaining} title="seconds" />
          </div>
        </div>
      </main>
